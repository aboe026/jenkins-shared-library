...
class ShieldsIoBadges implements Serializable {
    ...
    ShieldsIoBadges(Script steps) {
        steps.println "TEST steps.getClass().getName(): '${steps.getClass().getCanonicalName()}'"
        if (steps == null) {
    ...
    ShieldsIoBadges(Map params) {
        ...
        steps.println "TEST this.steps.getClass().getName(): '${this.steps.getClass().getCanonicalName()}'"
